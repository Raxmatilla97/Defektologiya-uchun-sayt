<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Yaratilgan kursni tahrirlash') }}
        </h2>
    </x-slot>
          ...
          <div class="grid gap-6 mb-6 lg:grid-cols-2">
              ...
              <div>
                ...
                <select id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    <option  selected value="logo" {{ old('category', $editCourse->category) === 'logo' ? 'selected' : '' }}>Logopediya</option>
                    <option value="oligo" {{ old('category', $editCourse->category) === 'oligo' ? 'selected' : '' }}>Oligofrenopedagogika</option>
                    <option value="surdo" {{ old('category', $editCourse->category) === 'surdo' ? 'selected' : '' }}>Surdopedagogika</option>
                </select>
              </div>
