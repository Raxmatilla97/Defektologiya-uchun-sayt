                        ...
                        <section class="container px-4 mx-auto">
                            ...
                            <div class="flex justify-center">
                              ...
                              <div class="flex ml-3 mt-8 justify-end">
                                <a href="{{route('dashboard.newsAndEventsCreate')}}">
                                                    ...
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                        ...
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                            <div class="flex items-center gap-x-6">
                                                                <form action="{{ route('dashboard.newsAndEventsDelete')}}" method="POST"                                                                
                                                                    style="display: inline-block;">
                                                                    <input type="hidden" name="_method" value="DELETE">
                                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                    <input type="text" style="opacity: 0;" name="news_id" value="{{$item->id}}">                                                                  
                                                                    ...
                                                                    <div id="modal" class="fixed inset-0 flex items-center justify-center  hidden">
                                                                        ...
                                                                        <div class="bg-white p-6 rounded shadow-lg z-0">
                                                                            <p class=" text-xl text-center">Xabarni o'chirishni <br> istaysizmi?</p>
                                                                    ...
                                                                    <script>
                                                                        function openModal(userId) {
                                                                            ...
                                                                            document.querySelector('input[name="news_id"]').value = userId;
                                                                        }
                                                                ...
                                                                <a href="{{ route('dashboard.newsAndEventsEdit', $item->slug)}}" class="text-gray-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-gray-300 hover:text-yellow-500 focus:outline-none">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
