<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __("Kurslarni ko'rish uchun so'rov jo'natgan foydalanuvchilar") }}
        </h2>
    </x-slot>
                    ...
                    <div class=" p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <section class="container px-4 mx-auto">
                            ...
                            <div class="flex justify-center">
                                <form action="{{ route('dashboard.allCoursesRequestSearch')}}" method="GET" class="flex flex-row flex-wrap">                               
                                  <div class="mb-4 mr-4">
                                                    ...
                                                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                                        ...
                                                        <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">          
                                                            ...
                                                            <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-indigo-100/60 dark:bg-indigo-800">
                                                                ...
                                                                <h2 class="text-sm font-normal text-indigo-500">Ariza tekshiruvda!</h2>
                                                            </div>
                                                            ...
                                                            <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                                                ...
                                                                <h2 class="text-sm font-normal text-emerald-500">Kursni ko'rishi mumkin!</h2>
                                                            </div>  
                                                            @endif                                            
                                                        ...
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                            <div class="flex items-center gap-x-6">
                                                                <form action="{{ route('dashboard.allCoursesRequestDelete')}}" method="POST"                                                                
                                                                    style="display: inline-block;">
                                                                    <input type="hidden" name="_method" value="DELETE">
                                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                    <input type="text" style="opacity: 0;" name="course_request_id" value="{{$item->id}}">
                                                                    ...
                                                                    <script>
                                                                        function openModal(userId) {
                                                                            ...
                                                                            document.querySelector('input[name="course_request_id"]').value = userId;
                                                                        }
                                                                ...
                                                                <a href="{{route('dashboard.requestCourseEdit', $item->id )}}" class="text-gray-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-gray-300 hover:text-yellow-500 focus:outline-none">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
