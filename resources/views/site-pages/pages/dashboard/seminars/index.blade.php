                    ...
                    <div class=" p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <section class="container px-4 mx-auto">
                            ...
                            <div class="flex justify-center">
                                <form action="{{ route('dashboard.seminarSearch')}}" method="GET" class="flex flex-row flex-wrap">                               
                                  <div class="mb-4 mr-4">
                                    <label for="title" class="block mb-2">Seminar sarlavhasi nomi:</label>
                                    <input type="text" id="title" value="{{ old('title', request()->query('title')) }}" name="title" class="w-full border border-gray-300 p-2" placeholder="Seminar sarlavhasi nomi...">
                                  </div>
                              ...
                              <div class="flex ml-3 mt-8 justify-end">
                                <a href="{{route('dashboard.seminarCreate')}}">
                                    <button type="submit" class="bg-green-600 hover:bg-green-500 text-white text-xl px-4 py-2 rounded">Seminar qo'shish</button>
                                </a>
                              </div>
                              <style>
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                                    ...
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        <div class="flex items-center gap-x-2">
                                                            ...
                                                            <span  class="bg-secondary py-1 px-3 text-sm font-semibold rounded text-white absolute bg-red-500 ">
                                                              Tugagan
                                                            </span>
                                                            @else
                                                            <span  class="bg-secondary py-1 px-3 text-sm font-semibold rounded text-white absolute bg-green-500 ">
                                                              {{$item->boladigan_kun->diffForHumans()}}
                                                            </span>
                                                            @endif 
                                                        </div>
                                                    </td>
                                                        <td class="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">          
                                                            ...
                                                            <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-red-100/60 dark:bg-red-800">
                                                                ...
                                                                <h2 class="text-sm font-normal text-red-500">Seminar ko'rinmas!</h2>
                                                            </div>                                                             
                                                            @elseif ($item->status == '1')
                                                            <div class="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                                                <span class="h-1.5 w-1.5 rounded-full bg-emerald-500"></span>
                                                                <h2 class="text-sm font-normal text-emerald-500">Seminar ko'rinarli!</h2>
                                                            </div>  
                                                            @endif                                            
                                                        ...
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                            <div class="flex items-center gap-x-6">
                                                                <form action="{{ route('dashboard.seminarDestroy')}}" method="POST"                                                                
                                                                    style="display: inline-block;">
                                                                    <input type="hidden" name="_method" value="DELETE">
                                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                                    <input type="text" style="opacity: 0;" name="seminar_id" value="{{$item->id}}">
                                                                    ...
                                                                    <div id="modal" class="fixed inset-0 flex items-center justify-center z-10 hidden">
                                                                        ...
                                                                        <div class="bg-white p-6 rounded shadow-lg z-0">
                                                                            <p class=" text-xl text-center">Seminarni o'chirishni <br> istaysizmi?</p>
                                                                    ...
                                                                    <script>
                                                                        function openModal(userId) {
                                                                            ...
                                                                            document.querySelector('input[name="seminar_id"]').value = userId;
                                                                        }
                                                                ...
                                                                <a href="{{ route('dashboard.seminarEdit', $item->slug)}}" class="text-gray-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-gray-300 hover:text-yellow-500 focus:outline-none">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
