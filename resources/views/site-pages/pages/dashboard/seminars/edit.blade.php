<x-app-layout>
    ...
    <div class="max-w-5xl mx-auto bg-white p-16 mt-6">
        ...
        <div class="mb-6">
            <div>
            <label for="content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Seminar haqida to'liq yozing</label>
        ...
        <div class="flex items-start mb-6">
            ...
            <input id="tafsiya_etilgan" type="checkbox" name="tafsiya_etilgan" value="1" {{ (old('tafsiya_etilgan') || $edit_info->tafsiya_etilgan) ? 'checked' : '' }} class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" >
            </div>
