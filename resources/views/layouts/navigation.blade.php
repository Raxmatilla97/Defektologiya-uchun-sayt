        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard.kurslarDashboardList') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.registerUsersList', 'register-users')" :active="request()->routeIs('dashboard.registerUsersList')">
                        {{ __('Foydalanuvchilar') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('dashboard.newsAndEvents')" :active="request()->routeIs('dashboard.newsAndEvents')">
                        {{ __('Xabarlar') }}
                    </x-nav-link>
                </div>
