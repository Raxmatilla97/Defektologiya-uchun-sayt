                    ...
                    <div class=" p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <section class="container px-4 mx-auto">
                            <div class="flex items-center gap-x-3">
                                <h2 class="text-lg font-medium text-gray-800 dark:text-white">Video kurslarni ko'rish uchun yuborilgan arizalar</h2>
    
                                <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">12 ta</span>
                            </div>
                        {{--     
                            @if(session('name'))
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                <thead class="bg-gray-50 dark:bg-gray-800">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Ariza yuborgan vaqti</th>
                                                ...
                                                {{-- @if ($arizalar)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                            <div class="inline-flex items-center gap-x-3">  
                                                                <div class="flex items-center gap-x-2">
                                                                    ...
                                                                    <div>
                                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Fayziyev Raxmatilla Xanshor o'g'li</h2>
                                                        ...
                                                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">AA303323</td>
                                                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Kurs nomi</td>
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                            <div class="flex items-center gap-x-2">
                                                                <p class="px-3 py-1 text-xs text-indigo-500 rounded-full dark:bg-gray-800 bg-indigo-100/60">20.2.2023</p>
                                                                {{-- {{ $ariza->created_at->diffForHumans() }} --}}
                                                            </div>
                                                        </td>
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
